...
# Ensure tqdm is installed before importing
try:
    import tqdm
...
# List of years to generate IDs for
years = list(range(1960, 2001))

# Function to generate dates for a specific year
...
# Function to generate all possibilities for a specific year and save to a file
